...
# #
# #     def get_frame(self):
# #         success, images = self.video.read()
...
# dbc.Button("Capture Picture", outline=True, color="primary",
#            className="mr-1", id='btn-1', n_clicks_timestamp=0),
# dbc.Button(
#     "Train Algorithm", outline=True, color="secondary",
#     className="mr-1", id='btn-2', n_clicks_timestamp=0
# ),
# dbc.Button("Facial Recogntion", outline=True, color="success",
#            className="mr-1", id='btn-3', n_clicks_timestamp=0),
# dbc.Button("Gradient", outline=True, color="warning",
#            className="mr-1", id='btn-4', n_clicks_timestamp=0),
